...
namespace Common.Analyzers.Diagnostics;
...
internal static class DiagnosticDescriptors
{
    ...
    internal static readonly DiagnosticDescriptor ExternalTypesMustBeInternal = new(
        ...
        messageFormat: "Type '{0}' must be declared internal inside External.* or Khaos.RestApi.External.* projects",
    ...
    internal static readonly DiagnosticDescriptor RestrictedHttpClientUsage = new(
        ...
        isEnabledByDefault: true,
        description: "Only Client.* or Khaos.RestApi.Client.* modules may allocate HttpClient; other layers must use prescribed abstractions.");
}
