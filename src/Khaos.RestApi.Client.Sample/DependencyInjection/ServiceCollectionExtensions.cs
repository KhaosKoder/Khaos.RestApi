...
namespace Khaos.RestApi.Client.Sample.DependencyInjection;
...
public static class ServiceCollectionExtensions
{
        ...
        IConfiguration configuration)
    {
        ...
        services.AddHttpClient<ISampleClient, SampleClient>((sp, client) =>
        {
            ...
            client.DefaultRequestHeaders.UserAgent.ParseAdd($"Khaos.RestApi.Client.{SampleClientConstants.ApiName}/1.0");
        });
