...
.DESCRIPTION
    Builds and packs the Khaos.RestApi solution into NuGet packages.
    This includes the Common libraries and Roslyn analyzers.
...
Write-Host ""
Write-Host "Packing Khaos.RestApi to $OutputDirectory" -ForegroundColor Cyan
Write-Host ""
...
try {
    ...
    dotnet @packArgs Khaos.RestApi.sln
