...
namespace Khaos.RestApi.Domain.ApiModuleSeed.Exceptions;

/// <summary>
/// Wraps upstream faults with contextual metadata that flows through ProblemDetails.
/// </summary>
public sealed class ApiModuleSeedExternalException : Exception
{
    private ApiModuleSeedExternalException(string message, Exception? innerException)
        : base(message, innerException)
    {
    }

    public static ApiModuleSeedExternalException FromResponse<T>(
        string operation,
        ...
        string? correlationId)
    {
        ...
        var exception = new ApiModuleSeedExternalException(message, response.Error);
