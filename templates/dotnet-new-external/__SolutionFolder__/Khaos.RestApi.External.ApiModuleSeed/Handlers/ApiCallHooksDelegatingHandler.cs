...
namespace Khaos.RestApi.External.ApiModuleSeed.Handlers;
...
internal sealed class ApiCallHooksDelegatingHandler : DelegatingHandler
{
    ...
    protected override async Task<HttpResponseMessage> SendAsync(HttpRequestMessage request, CancellationToken cancellationToken)
    {
        ...
        using var span = _tracer.StartSpan($"Khaos.RestApi.External.{ApiModuleSeedConstants.ApiName}.{request.Method.Method}");
