...
using Common.Analyzers.Diagnostics;
using Common.Analyzers.Tests.Verifiers;
using Microsoft.CodeAnalysis;
using Microsoft.CodeAnalysis.Testing;
using Xunit;

namespace Common.Analyzers.Tests;
...
namespace Khaos.RestApi.External.Sample;
...
";
        ...
        var test = TestHelpers.CreateAnalyzerTest(
            assemblyName: "Khaos.RestApi.External.Sample",
        ...
        var expected = new DiagnosticResult(DiagnosticDescriptors.ExternalCannotReferenceOtherLayers)
            .WithSpan(1, 1, 1, 1)
            .WithArguments("Khaos.RestApi.External.Sample", "Domain.Cases");
...
namespace Khaos.RestApi.Domain.Sample;
...
";
        ...
        var test = TestHelpers.CreateAnalyzerTest(
            assemblyName: "Khaos.RestApi.Domain.Sample",
        ...
        var expected = new DiagnosticResult(DiagnosticDescriptors.DomainCannotReferenceDisallowedLayers)
            .WithSpan(1, 1, 1, 1)
            .WithArguments("Khaos.RestApi.Domain.Sample", "Client.Cases");
        test.ExpectedDiagnostics.Add(expected);
...
namespace Khaos.RestApi.Internal.Sample;
...
";
        ...
        var test = TestHelpers.CreateAnalyzerTest(
            assemblyName: "Khaos.RestApi.Internal.Sample",
    ...
    [assembly: InternalsVisibleTo(""Khaos.RestApi.Internal.Sample"")]
    ...
    ");
        ...
        var expected = new DiagnosticResult(DiagnosticDescriptors.InternalCannotReferenceExternal)
            .WithSpan(1, 1, 1, 1)
            .WithArguments("Khaos.RestApi.Internal.Sample", "External.Cases");
        test.ExpectedDiagnostics.Add(expected);
...
";
        ...
        var test = TestHelpers.CreateAnalyzerTest("Khaos.RestApi.Domain.Sample");
        test.TestCode = source;
...
namespace Khaos.RestApi.Client.Sample;
...
";
        ...
        var test = TestHelpers.CreateAnalyzerTest("Khaos.RestApi.Client.Sample");
        test.TestCode = source;
        await test.RunAsync();
    }
}
