...
";
        ...
        var expected = new DiagnosticResult(DiagnosticDescriptors.ExternalCannotReferenceOtherLayers)
            .WithSpan(1, 1, 1, 1)
            .WithArguments("External.Sample", "Domain.Cases");
...
";
        ...
        var expected = new DiagnosticResult(DiagnosticDescriptors.DomainCannotReferenceDisallowedLayers)
            .WithSpan(1, 1, 1, 1)
            .WithArguments("Domain.Sample", "Client.Cases");
        test.ExpectedDiagnostics.Add(expected);
...
";
    ...
    [assembly: InternalsVisibleTo(""Internal.Sample"")]
    ...
    ");
        ...
        var expected = new DiagnosticResult(DiagnosticDescriptors.InternalCannotReferenceExternal)
            .WithSpan(1, 1, 1, 1)
            .WithArguments("Internal.Sample", "External.Cases");
        test.ExpectedDiagnostics.Add(expected);
...
";
        ...
        var test = TestHelpers.CreateAnalyzerTest("Domain.Sample");
        test.TestCode = source;
...
";
        ...
        var test = TestHelpers.CreateAnalyzerTest("Client.Sample");
        test.TestCode = source;
        await test.RunAsync();
    }
}
